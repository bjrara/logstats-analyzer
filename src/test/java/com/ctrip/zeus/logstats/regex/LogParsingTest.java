...
public class LogParsingTest {
    ...
    public void testParser() {
        final String log = "[08/Mar/2016:15:31:39 +0800] a.com 0359 192.22.25.94 POST /Activity-Order-OrderService/api/xml/AutoOrder?format=json 80 - 192.22.28.241 192.22.42.237 HTTP/1.1 \"-\" \"-\" \"-\" 200 652 815 0.019 0.018 : 0.1 192.22.44.22:80 : 192.0.0.1:80 200 : 400 backend_6004";
        String[] expectedValues = {"08/Mar/2016:15:31:39 +0800", "a.com", "0359", "192.22.25.94", "POST", "/Activity-Order-OrderService/api/xml/AutoOrder", "80", "-", "192.22.28.241", "192.22.42.237", "HTTP/1.1", "-", "-", "-", "200", "652", "815", "0.019", "0.018 : 0.1", "192.22.44.22:80 : 192.0.0.1:80", "200 : 400", "backend_6004"};
    ...
    public void testParser2() {
        String logFormat = "[$time_local] $host $hostname $server_addr $request_method $uri \"$query_string\" $server_port $remote_user $remote_addr $http_x_forwarded_for $server_protocol \"$http_user_agent\" \"$cookie_COOKIE\" \"$http_referer\" $host $status $body_bytes_sent $request_time $upstream_response_time $upstream_addr $upstream_status";
        String log1 = "[17/Nov/2015:15:10:44 +0800] ws.you.localhost svr09191 192.8.95.27 POST /gsapi/api/xml/GetRecmdProduct \"-\" 80 - 192.8.106.66 - HTTP/1.1 \"-\" \"-\" \"-\" ws.you.localhost 200 521 0.042 0.039 192.8.168.228:80 200";
        String log2 = "[02/Dec/2015:13:02:19 +0800] ws.util.you.localhost svr09191 192.8.95.27 POST /bgmgmt/api/json/ExecUpdateContentProcess \"-\" 80 - 192.15.114.31 192.32.65.134, 192.15.202.207 HTTP/1.1 \"python-requests/2.2.0 CPython/2.7.6 Windows/7\" \"-\" \"-\" ws.util.you.localhost 200 143 0.005 0.005 192.8.24.101:80 200";
        String log3 = "[02/Dec/2015:13:43:03 +0800] ws.mobile.qiche.localhost svr09191 192.8.95.27 POST /app/index.php \"param=/api/home&method=config.getAppConfig&_fxpcqlniredt=09031130410105805720\" 80 - 192.15.138.65 117.136.75.139 HTTP/1.1 \"\" \"-\" \"http://m.localhost/webapp/train/?allianceid=106334&sid=728666&ouid=4&sourceid=2377\" ws.mobile.qiche.localhost 200 99 0.017 0.017 192.8.119.73:80 200";
        String log4 = "[02/Dec/2015:13:00:10 +0800] ws.schedule.localhost svr09191 192.8.95.27 POST /UbtPushApi/UserActionReceiveHandler.ashx \"-\" 80 - 192.8.91.104 - HTTP/1.1 \"Java/THttpClient/HC\" \"-\" \"-\" ws.schedule.localhost 200 24 0.007 0.007 192.8.168.238:80 200";
    ...
    public void testRealCases() {
        ...
        realCases.add("[01/Jun/2016:09:00:13 +0800] ws.mobile.qiche.localhost svr5153hw1288 192.8.208.7 GET /index.php?param=/api/home&method=product.recommendBus&isNewVersion=1&from=%E6%B8%A9%E5%B7%9E&to=%E6%B8%A9%E5%B7%9E&date=2016-06-01&channel=tieyou&partner=tieyou.app 80 - 192.228.56.26 - HTTP/1.1 \"-\" \"-\" \"-\" 200 268 362 0.045 -, -, 0.045 192.8.169.162:80, 192.8.169.164:80, 192.8.177.23:80 -, -, 200 backend_441");
    ...
    public void testInternalRewriteParser() {
        String logFormat = "[$time_local] $host $hostname $server_addr $request_method $uri \"$query_string\" $server_port $remote_user $remote_addr $http_x_forwarded_for $server_protocol \"$http_user_agent\" \"$cookie_COOKIE\" \"$http_referer\" $host $status $body_bytes_sent $request_time $upstream_response_time $upstream_addr $upstream_status";
        String log = "[02/Feb/2016:17:01:02 +0800] ws.connect.qiche.localhost svr14669 192.8.208.22 GET /502page \"-\" 80 - 192.8.78.102 - HTTP/1.1 \"-\" \"-\" \"-\" ws.connect.qiche.localhost 502 6003 0.015 - : 0.006 192.8.91.168:80 : 192.8.16.4:80 - : 200";
    ...
    public void testJsonSerializer() {
        final String log = "[08/Mar/2016:15:31:39 +0800] a.com 0359 192.22.25.94 POST /Activity-Order-OrderService/api/xml/AutoOrder?format=json 80 - 192.22.28.241 192.22.42.237 HTTP/1.1 \"-\" \"-\" \"-\" 200 652 815 0.019 0.018 : 0.1 192.22.44.22:80 : 192.0.0.1:80 200 : 400 backend_6004";
        String expectedJsonValue = "{\"time_local\":\"08/Mar/2016:15:31:39 +0800\",\"host\":\"a.com\",\"hostname\":\"0359\",\"server_addr\":\"192.22.25.94\",\"request_method\":\"POST\",\"request_uri\":\"/Activity-Order-OrderService/api/xml/AutoOrder\",\"server_port\":\"80\",\"remote_user\":\"-\",\"remote_addr\":\"192.22.28.241\",\"http_x_forwarded_for\":\"192.22.42.237\",\"server_protocol\":\"HTTP/1.1\",\"http_user_agent\":\"-\",\"http_cookie\":\"-\",\"http_referer\":\"-\",\"status\":\"200\",\"request_length\":\"652\",\"bytes_sent\":\"815\",\"request_time\":\"0.019\",\"upstream_response_time\":\"0.018 : 0.1\",\"upstream_addr\":\"192.22.44.22:80 : 192.0.0.1:80\",\"upstream_status\":\"200 : 400\",\"proxy_host\":\"backend_6004\"}";
